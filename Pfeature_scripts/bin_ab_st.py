...
def main(argv):
    ...
    number = 1
    if len(argv[1:]) == 0:
        print ("\nUsage: bin_ab_st.py -i inputfile -o outputfile  -n number\n")
    ...
    for opt, arg in opts:
        if opt == '--help' or opt == '--h':
            print ('\nbin_ab_st.py -i inputfile -o outputfile -m number1 -n number\n')
    ...
    bin_ab_st(sys.argv[2],sys.argv[4],int(sys.argv[6]))
