...
def main(argv):
    ...
    #option = 1	
    if len(argv[1:]) == 0:
        print ("\nUsage: pcp_wp.py -i inputfile -o outputfile -n number\n")
    ...
    try:
      opts, args = getopt.getopt(argv,"i:o:n:",["ifile=","ofile=","n="])
        ...
        print('inputfile : file of peptide/protein sequences for which descriptors need to be generated\n') 
        print('outputfile : is the file of feature vectors\n')	
        print('number1 : number of C-Terminal residues\n')			
        sys.exit(2)
    for opt, arg in opts:
        if opt == '--help' or opt == '--h':
            print ('\npcp_wp.py -i inputfile -o outputfile -n number\n')
            print('inputfile : file of peptide/protein sequences for which descriptors need to be generated\n') 
            print('outputfile : is the file of feature vectors\n')		
            print('number1 : number of C-Terminal residues\n')				
            sys.exit()
    ...
    pcp_ct(sys.argv[2],sys.argv[4],'CT',int(sys.argv[6]),int(sys.argv[6]))
