...
def main(argv):
    ...
    number2 = 1
    if len(argv[1:]) == 0:
        print ("\nUsage: apaac_st.py -i inputfile -o outputfile  -l lambda -n Number_of_splits\n")
    ...
    for opt, arg in opts:
        if opt == '--help' or opt == '--h':
            print ('\napaac_st.py -i inputfile -o outputfile  -l lambda -n Number_of_splits')
            ...
            n2 = int(sys.argv[8])
    apaac_st(sys.argv[2],sys.argv[4],int(sys.argv[6]),int(sys.argv[8]))
