...
def main(argv):
    ...
    mo = 'all'	
    if len(argv[1:]) == 0:
        print ("\nUsage: aai_wp.py -i inputfile -o outputfile\n")
    ...
    try:
      opts, args = getopt.getopt(argv,"i:o:",["ifile=","o="])
    ...
    for opt, arg in opts:
        if opt == '--help' or opt == '--h':
            print ('\naai_wp.py -i inputfile -o outputfile\n')
            print('inputfile : file of peptide/protein sequences for which descriptors need to be generated\n') 
            print('outputfile : is the file of feature vectors\n')
