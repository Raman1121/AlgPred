...
def main(argv):
    ...
    #option = 1	
    if len(argv[1:]) == 0:
        print ("\nUsage: pcp_wp.py -i inputfile -o outputfile  -m number1 -n number2\n")
    ...
    for opt, arg in opts:
        if opt == '--help' or opt == '--h':
            print ('\npcp_wp.py -i inputfile -o outputfile  -m number1 -n number2\n')
            print('inputfile : file of peptide/protein sequences for which descriptors need to be generated\n') 
            print('outputfile : is the file of feature vectors\n')		
            print('number1 : number of N-Terminal residues\n')	
            print('number2 : number of C-Terminal residues\n')			
            ...
            outputfile = arg
        elif opt in ("-m", "--number1"):
            m = int(sys.argv[6])			
        elif opt in ("-n", "--number2"):
            n = int(sys.argv[8])			
			
    
    pcp_rt(sys.argv[2],sys.argv[4],'rest',int(sys.argv[6]),int(sys.argv[8]))
